...
#define EP0_ADDR        (EP3_ADDR + EP3_BUF_SIZE)
...
extern __code uint16_t InterfDescr2[];
...
#define USB_STR_DESCR_i4    (uint8_t*)InterfDescr1
#define USB_STR_DESCR_i5    (uint8_t*)InterfDescr2
